...
export const TextRevealCard = ({
  ...
  return (
    (<div
      ...
      ref={cardRef}
      className={cn(
        "bg-[#020817] w-full rounded-lg p-2 relative overflow-hidden text-center flex justify-center",
        className
      )}>
      {children}
      <div className="h-20  relative flex items-center overflow-hidden">
        ...
        <div
          ...
          <p
            className="text-base sm:text-[4rem] py-10 font-bold bg-clip-text text-transparent bg-[#323238]">
            {text}
          </p>
          <MemoizedStars />
        </div>
